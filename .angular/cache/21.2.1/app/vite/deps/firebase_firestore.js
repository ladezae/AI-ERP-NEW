  ...
  switch (n) {
    ...
    case 10:
      return (function __PRIVATE_compareVectors(e2, t2) {
        const n2 = e2.fields || {}, r2 = t2.fields || {}, i = n2[ct]?.arrayValue, s = r2[ct]?.arrayValue, o = __PRIVATE_primitiveComparator(i?.values?.length || 0, s?.values?.length || 0);
        if (0 !== o) return o;
...
function __PRIVATE_isVectorValue(e) {
  const t = (e?.mapValue?.fields || {})[ot]?.stringValue;
  return t === ut;
}
    ...
    if (r) {
      ...
      if (__PRIVATE_targetIsDocumentTarget(i)) if (0 === n) {
        ...
        if (r2 !== n) {
          ...
          dt?.lt((function __PRIVATE_createExistenceFilterMismatchInfoForTestingHooks(e2, t2, n3, r3, i3) {
            const s = {
              localCacheCount: e2,
...
var ParseContextImpl = class _ParseContextImpl {
  ...
  contextWith(e) {
    return new _ParseContextImpl(__spreadValues(__spreadValues({}, this.settings), e), this.databaseId, this.serializer, this.ignoreUndefinedProperties, this.fieldTransforms, this.fieldMask);
  }
...
var AbstractUserDataWriter = class {
  ...
  convertVectorValue(e) {
    const t = e.fields?.[ct].arrayValue?.values?.map(((e2) => __PRIVATE_normalizeNumber(e2.doubleValue)));
  ...
  const r = (function __PRIVATE_parseIndexes(t2) {
    const e2 = "string" == typeof t2 ? (function __PRIVATE_tryParseJson(t3) {
      try {
        ...
        throw new FirestoreError(C.INVALID_ARGUMENT, "Failed to parse JSON: " + t4?.message);
      }
    })(t2) : t2, n2 = [];
...
var __PRIVATE_TestingHooksSpiImpl = class ___PRIVATE_TestingHooksSpiImpl {
  ...
  onExistenceFilterMismatch(t) {
    const e = /* @__PURE__ */ Symbol(), n = this.i;
